...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 05, 2026 at 06:16 AM
...
(47, 20, 'js-variables and operators', 'JavaScript Variables & Operators', 'Learn how to store values and use operators.', 100, 50, 1),
...
--
-- Table structure for table `daily_ai_usage`
--
...
--
-- Dumping data for table `daily_ai_usage`
--

INSERT INTO `daily_ai_usage` (`user_id`, `usage_count`, `last_used_date`) VALUES
(8, 3, '2025-12-19');
...
(245, 86, '<h1>Hello World!</h1>', 1),
(246, 86, '<p>Hello World!</p>', 0),
(247, 86, '<div>Hello World!</div>', 0),
(248, 86, '<a>Hello World!</a>', 0),
(249, 87, '<p>Welcome</p>', 0),
(250, 87, '<heading>Welcome</heading>', 0),
(251, 87, '<h1>Welcome</h1>', 1),
(252, 87, '<title>Welcome</title>', 0);
...
INSERT INTO `lesson_comments` (`id`, `lesson_content_id`, `user_id`, `comment_text`, `created_at`, `updated_at`) VALUES
(1, 84, 8, 'Oh wow. A heading, seriously?', '2025-11-02 06:56:10', '2025-11-02 06:56:10'),
(2, 85, 8, 'too plain, but worked somehow', '2025-11-02 06:59:45', '2025-11-02 07:36:18'),
(4, 84, 9, 'hi', '2025-11-02 08:17:16', '2025-11-02 08:17:16');

-- --------------------------------------------------------

--
-- Table structure for table `lesson_comment_likes`
--
...
--
-- Dumping data for table `lesson_comment_likes`
--

INSERT INTO `lesson_comment_likes` (`id`, `comment_id`, `user_id`, `created_at`) VALUES
(20, 2, 8, '2025-11-02 22:15:47'),
(24, 2, 7, '2025-11-03 01:29:02'),
(25, 4, 9, '2025-11-05 08:41:32');

-- --------------------------------------------------------

--
-- Table structure for table `lesson_comment_replies`
--
...
--
-- Dumping data for table `lesson_comment_replies`
--

INSERT INTO `lesson_comment_replies` (`id`, `comment_id`, `user_id`, `reply_text`, `created_at`, `updated_at`) VALUES
(1, 1, 9, 'wdym, it is fundamental', '2025-11-02 07:03:43', '2025-11-02 07:03:43');
...
(84, 44, 1, 'Intro to Text & Headings', '<h5>\r\nEvery webpage starts with text — headings for titles and paragraphs for regular content. <br><br>\r\n\r\n`<h1>` to `<h6>` tag → headings, from biggest to smallest. <br>\r\n`<p>` tag → paragraph of text.\r\n<h5><br>', '/static/uploads/lesson_images\\1761528211_a-1702048418566-2x.png', '<h1>This is the Page Title</h1>\r\n<p>Try modifying the heading tags above.</p>', 'Next', 'text_image', '', '', ''),
(85, 44, 2, 'Example', '<h5>This code below displays a `heading` and a `paragraph`:<h5><br>', NULL, '<h1>Hello World!</h1>\r\n<p>This is my first webpage.</p>\r\n', 'Next', 'text_code', '', '', ''),
(86, 44, 3, 'MCQ', 'You want to show a simple message “Hello World!” as a `heading` on your webpage. <br><br>Which HTML tag should you use?<br>', NULL, '<h1>Hello World!</h1>\r\n<p>This is my first webpage.</p>\r\n', 'Next', 'quiz', 'Great choice! Headings like `<h1>` are perfect for important text like page titles or big messages.', '`<h1>` to `<h6>` is used for the main heading at the top of your page.', ''),
(87, 44, 4, 'MCQ', '<h6>You are creating a page `heading` called “Welcome” at the top of your site. <br><br>Which tag is correct?<h6><br>', NULL, '<h1>Hello World!</h1>\r\n<p>This is my first webpage.</p>\r\n', 'Next', 'quiz', 'Awesome! `<h1>` is for the main heading at the top of your page. You can use `<h2>`, `<h3>` … for subheadings.', 'Again, `<h1>` to `<h6>` is used for the main heading at the top of your page.', ''),
(88, 44, 5, 'Practice Headings & Paragraphs', '<h5>\r\nTry editing this code below using different headings:<h5><br>', NULL, '<h1>This is the Page Title</h1>\r\n<p>Try modifying the heading tags above.</p>', 'Next', 'playground', '', '', ''),
(89, 44, 6, 'Lesson Takeaways', '<h4>Lesson Takeaways - HTML Text & Headings<h4><br>\r\n\r\n<h5>\r\n`<h1>` to `<h6>` = headings (biggest to smallest). <br>\r\n`<p>` = paragraph text. <br>\r\nHeadings organize your content, paragraphs add details.\r\n<h5><br>', NULL, '', 'Next', 'text_image', '', '', ''),
...
(130, 8, 39, 1, 36, 1, 0, '2025-12-19 02:23:27'),
(131, 8, 39, 2, 183, 1, 0, '2025-11-02 14:17:16'),
(132, 8, 39, 3, 4, 1, 0, '2025-11-02 14:17:47'),
(133, 8, 39, 4, 2, 1, 0, '2025-11-02 14:17:53'),
(134, 8, 39, 5, 160, 1, 0, '2025-10-21 09:27:50'),
(135, 8, 39, 6, 3, 1, 0, '2025-10-21 09:28:34'),
(136, 8, 39, 7, 2, 1, 0, '2025-10-21 09:28:51'),
(137, 8, 39, 8, 23, 1, 0, '2025-10-21 09:29:04'),
(138, 8, 39, 9, 63, 1, 0, '2025-10-21 09:29:26'),
(139, 8, 39, 10, 1, 1, 0, '2025-10-21 09:29:34'),
...
(158, 8, 44, 1, 14, 1, 0, '2025-12-21 17:19:46'),
(159, 8, 44, 2, 6, 1, 0, '2025-12-21 17:19:47'),
(160, 8, 44, 3, 29, 1, 1, '2025-12-21 17:20:29'),
(161, 8, 44, 4, 40, 1, 1, '2025-12-21 17:20:33'),
(162, 8, 44, 5, 50, 1, 0, '2025-12-21 17:20:38'),
(163, 8, 44, 6, 14, 1, 0, '2025-12-21 17:20:38'),
(164, 8, 44, 7, 4, 1, 0, '2025-12-21 17:20:47'),
(165, 8, 45, 1, 41, 1, 0, '2025-11-02 14:12:57'),
(166, 8, 45, 2, 0, 1, 0, '2025-11-02 14:12:58'),
(167, 8, 45, 3, 13, 1, 0, '2025-11-02 14:13:04'),
(168, 8, 45, 4, 1, 1, 0, '2025-11-02 14:13:05'),
(169, 8, 45, 5, 5, 1, 0, '2025-11-02 14:13:09'),
(170, 8, 45, 6, 1, 1, 0, '2025-11-02 14:13:09'),
(171, 8, 45, 7, 14, 1, 0, '2025-11-02 14:13:15'),
(172, 8, 45, 8, 47, 1, 0, '2025-11-02 14:13:15'),
(173, 8, 45, 9, 1, 1, 0, '2025-11-02 14:13:24'),
...
(201, 8, 47, 6, 2, 1, 0, '2025-10-21 21:28:31'),
...
(228, 22, 44, 1, 2, 1, 0, '2025-10-20 11:42:55'),
(229, 22, 44, 2, 0, 1, 0, '2025-10-20 11:42:55'),
(230, 22, 44, 3, 7, 1, 0, '2025-10-20 11:43:02'),
(231, 22, 44, 4, 3, 1, 0, '2025-10-20 11:43:22'),
(232, 22, 44, 5, 10, 1, 0, '2025-10-20 11:43:33'),
(233, 22, 44, 6, 1, 1, 0, '2025-10-20 11:43:34'),
(234, 22, 44, 7, 3, 1, 0, '2025-10-20 11:43:38'),
(235, 22, 45, 1, 2, 1, 0, '2025-10-20 11:43:50'),
(236, 22, 45, 2, 3, 1, 0, '2025-10-20 11:43:53'),
(237, 22, 45, 3, 14, 1, 0, '2025-10-20 11:44:07'),
(238, 22, 45, 4, 4, 1, 0, '2025-10-20 11:44:12'),
(239, 22, 45, 5, 7, 1, 0, '2025-10-20 11:44:20'),
(240, 22, 45, 6, 0, 1, 0, '2025-10-20 11:44:20'),
(241, 22, 45, 7, 5, 1, 1, '2025-10-20 11:44:26'),
(242, 22, 45, 8, 0, 1, 0, '2025-10-20 11:44:27'),
(243, 22, 45, 9, 3, 1, 0, '2025-10-20 11:44:31'),
(307, 32, 44, 1, 76, 1, 0, '2025-10-20 13:31:19'),
(308, 7, 44, 3, 1, 1, 1, '2025-11-04 21:44:45'),
(309, 7, 44, 4, 1, 1, 0, '2025-11-04 21:44:48'),
(310, 7, 44, 5, 0, 1, 0, '2025-11-04 21:44:49'),
(311, 7, 44, 6, 0, 1, 0, '2025-11-04 21:44:59'),
(312, 7, 44, 7, 2, 1, 0, '2025-11-04 21:45:34'),
(313, 7, 44, 1, 2, 1, 0, '2025-11-04 21:44:38'),
(314, 7, 44, 2, 0, 1, 0, '2025-11-04 21:44:41'),
(315, 7, 47, 1, 3, 1, 0, '2025-11-04 21:45:53'),
(316, 7, 47, 2, 23, 1, 0, '2025-10-21 15:12:17'),
(317, 7, 47, 3, 3, 1, 1, '2025-10-21 15:12:21'),
(318, 7, 47, 4, 25, 1, 0, '2025-10-21 15:12:47'),
(319, 7, 47, 5, 10, 1, 1, '2025-10-21 15:12:58'),
(320, 7, 47, 6, 14, 1, 0, '2025-10-21 15:13:12'),
(321, 7, 47, 7, 3, 1, 0, '2025-10-21 15:13:16'),
(322, 8, 47, 7, 3, 1, 0, '2025-10-21 21:28:34'),
(323, 9, 44, 1, 3, 1, 0, '2025-11-05 01:12:15'),
(324, 9, 44, 2, 0, 1, 0, '2025-11-05 00:41:55'),
(325, 9, 44, 3, 2, 1, 0, '2025-11-05 00:42:07'),
(326, 9, 44, 4, 1, 1, 0, '2025-11-05 00:42:18'),
(327, 9, 44, 5, 0, 1, 0, '2025-11-05 00:42:23'),
(328, 9, 44, 6, 0, 1, 0, '2025-11-05 00:42:24'),
(329, 9, 44, 7, 4, 1, 0, '2025-11-05 00:42:54'),
(330, 7, 39, 1, 183, 1, 0, '2025-10-22 17:43:51'),
(331, 34, 44, 1, 20, 1, 0, '2025-10-28 18:38:51'),
(332, 34, 44, 2, 7, 1, 0, '2025-10-28 18:38:59'),
(333, 34, 44, 3, 13, 1, 0, '2025-10-28 18:39:12'),
(334, 34, 44, 4, 11, 1, 0, '2025-10-28 18:39:24'),
(335, 34, 44, 5, 232, 1, 0, '2025-10-28 18:43:16'),
(336, 34, 44, 6, 4, 1, 0, '2025-10-28 18:43:21'),
(337, 34, 44, 7, 22, 1, 0, '2025-10-28 18:43:43'),
(338, 34, 45, 1, 14, 1, 0, '2025-10-28 18:44:00'),
(339, 34, 45, 2, 12, 1, 0, '2025-10-28 18:44:12'),
(340, 34, 45, 3, 13, 1, 0, '2025-10-28 18:45:27'),
(341, 34, 45, 4, 217, 1, 0, '2025-10-28 18:49:05'),
(342, 34, 45, 5, 16, 1, 0, '2025-10-28 18:49:35'),
(343, 34, 45, 6, 11, 1, 0, '2025-10-28 18:52:39'),
(344, 34, 45, 7, 3, 1, 0, '2025-10-28 18:52:31'),
(345, 35, 44, 1, 4, 1, 0, '2025-11-04 19:22:06'),
(346, 35, 44, 2, 2, 1, 0, '2025-11-04 19:22:07'),
(347, 35, 44, 3, 5, 1, 0, '2025-11-04 19:22:11'),
(348, 35, 44, 4, 2, 1, 0, '2025-11-04 19:22:33'),
(349, 35, 44, 5, 13, 1, 0, '2025-11-04 19:22:42'),
(350, 35, 44, 6, 1, 1, 0, '2025-11-04 19:22:44'),
(351, 35, 44, 7, 11, 1, 0, '2025-10-29 14:36:20'),
(352, 9, 45, 1, 8, 1, 0, '2025-11-02 00:43:08'),
(353, 9, 46, 1, 3, 1, 0, '2025-11-01 23:19:57'),
(354, 9, 46, 2, 0, 1, 0, '2025-11-01 23:19:58'),
(355, 7, 45, 1, 3, 1, 0, '2025-11-04 21:45:44'),
(356, 8, 48, 1, 7, 1, 0, '2025-12-19 01:10:02'),
(357, 8, 48, 2, 2, 1, 0, '2025-12-19 01:10:05');
...
--
-- Table structure for table `lesson_reply_likes`
--

CREATE TABLE `lesson_reply_likes` (
  `id` int(11) NOT NULL,
...
(19, NULL, 'CSS', 'Learn to style your website through Cascading Style Sheets. Add headings, center a div, and more!', NULL, NULL, NULL, '/static/images/css-logo.png'),
(20, NULL, 'JavaScript', 'Learn JavaScript to add interactivity, control behavior, and make your sites dynamic.', NULL, NULL, NULL, '/static/images/javascript.png');

-- --------------------------------------------------------

--
-- Table structure for table `pvp_code_battle_history`
--

CREATE TABLE `pvp_code_battle_history` (
  `id` int(11) NOT NULL,
  ...
  `player1_completed` int(11) DEFAULT 0,
  `player2_completed` int(11) DEFAULT 0,
  `challenges_used` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`challenges_used`)),
  `duration` int(11) DEFAULT NULL,
  `ended_reason` enum('completed','timeout','surrender') DEFAULT 'timeout',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `pvp_code_battle_history`
--

INSERT INTO `pvp_code_battle_history` (`id`, `match_id`, `player1_id`, `player2_id`, `winner_id`, `player1_score`, `player2_score`, `player1_completed`, `player2_completed`, `challenges_used`, `duration`, `ended_reason`, `created_at`) VALUES
(1, 'code_battle_35_35_1762277893', 35, 35, NULL, 0, 0, 0, 0, '[2, 3, 4, 5, 6]', 851, 'timeout', '2025-11-04 17:52:25');

-- --------------------------------------------------------

--
-- Table structure for table `pvp_code_challenges`
--

CREATE TABLE `pvp_code_challenges` (
  `id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  ...
  `difficulty` enum('easy','normal','intermediate','hard') DEFAULT 'normal',
  `time_limit` int(11) DEFAULT 300,
  `points_reward` int(11) DEFAULT 100,
  `category` varchar(100) DEFAULT 'general',
  `requires_html` tinyint(1) DEFAULT 0,
  `requires_css` tinyint(1) DEFAULT 0,
  `requires_js` tinyint(1) DEFAULT 1,
  `test_cases` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`test_cases`)),
  `hint` text DEFAULT NULL,
  `expected_approach` text DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `pvp_code_challenges`
--

INSERT INTO `pvp_code_challenges` (`id`, `title`, `description`, `function_name`, `starter_code`, `language`, `difficulty`, `time_limit`, `points_reward`, `category`, `requires_html`, `requires_css`, `requires_js`, `test_cases`, `hint`, `expected_approach`, `created_at`) VALUES
(2, 'Sum Two Numbers', 'Write a function that returns the sum of two numbers.', 'sumTwo', '{\"html\": \"\", \"css\": \"\", \"javascript\": \"function sumTwo(a, b) {\\r\\n  // Your code here\\r\\n  return 0;\\r\\n}\"}', 'javascript', 'easy', 300, 50, 'javascript', 0, 0, 1, '[{\"test_type\": \"function\", \"expected\": \"3\", \"input\": \"1,2\"}, {\"test_type\": \"function\", \"expected\": \"10\", \"input\": \"7,3\"}]', 'Use the + operator to add the two parameters.', 'Simply return a + b', '2025-11-05 00:52:17'),
(3, 'Reverse String', 'Write a function that reverses a string.', 'reverseString', '{\"html\":\"\",\"css\":\"\",\"javascript\":\"function reverseString(str) {\\n  // Your code here\\n  return str;\\n}\"}', 'javascript', 'normal', 300, 100, 'javascript', 0, 0, 1, '[{\"type\":\"function\",\"description\":\"Should reverse \'hello\' to \'olleh\'\",\"function_name\":\"reverseString\",\"input\":[\"hello\"],\"output\":\"olleh\"},{\"type\":\"function\",\"description\":\"Should reverse \'world\' to \'dlrow\'\",\"function_name\":\"reverseString\",\"input\":[\"world\"],\"output\":\"dlrow\"}]', 'Use array methods like split(), reverse(), and join().', 'Convert string to array, reverse it, then join back', '2025-11-05 00:52:17'),
(4, 'Create Simple Card', 'Create a card with a title and description. The card should have 20 pixels of padding, a border, and centered text.', '', '{\"html\":\"<div class=\\\"card\\\">\\n  <h2>Card Title</h2>\\n  <p>Card description goes here.</p>\\n</div>\",\"css\":\".card {\\n  /* Add your styles here */\\n}\",\"javascript\":\"\"}', 'html', 'normal', 300, 100, 'html-css', 1, 1, 0, '[{\"type\":\"html\",\"description\":\"Should have a div with class card\",\"selector\":\".card\",\"expected\":{\"exists\":true,\"count\":1}},{\"type\":\"css\",\"description\":\"Card should have padding\",\"selector\":\".card\",\"expected\":{\"padding\":\"20px\"}},{\"type\":\"css\",\"description\":\"Text should be centered\",\"selector\":\".card\",\"expected\":{\"text-align\":\"center\"}}]', 'Use text-align: center for centering. Add padding and border to the .card class.', 'Apply padding, border, and text-align to the card class', '2025-11-05 00:52:17'),
(5, 'Flexbox Layout', 'Create a responsive flex container with 3 items that stack vertically on mobile (<768px).', '', '{\"html\":\"<div class=\\\"container\\\">\\n  <div class=\\\"item\\\">Item 1</div>\\n  <div class=\\\"item\\\">Item 2</div>\\n  <div class=\\\"item\\\">Item 3</div>\\n</div>\",\"css\":\".container {\\n  /* Add flexbox styles */\\n}\\n\\n.item {\\n  /* Style items */\\n}\",\"javascript\":\"\"}', 'html', 'intermediate', 300, 150, 'layout', 1, 1, 0, '[{\"type\":\"css\",\"description\":\"Container should use flexbox\",\"selector\":\".container\",\"expected\":{\"display\":\"flex\"}},{\"type\":\"css\",\"description\":\"Should have gap between items\",\"selector\":\".container\",\"expected\":{\"gap\":\"20px\"}},{\"type\":\"html\",\"description\":\"Should have 3 items\",\"selector\":\".item\",\"expected\":{\"count\":3}}]', 'Use display: flex on container. Add media query for mobile.', 'Use flexbox with flex-direction and media queries', '2025-11-05 00:52:17'),
(6, 'Interactive Counter', 'Create a counter with buttons to increment, decrement, and reset. Display the count value.', '', '{\"html\":\"<div class=\\\"counter\\\">\\n  <button id=\\\"decrease\\\">-</button>\\n  <span id=\\\"count\\\">0</span>\\n  <button id=\\\"increase\\\">+</button>\\n  <button id=\\\"reset\\\">Reset</button>\\n</div>\",\"css\":\".counter {\\n  /* Style the counter */\\n}\\n\\nbutton {\\n  /* Style buttons */\\n}\",\"javascript\":\"// Add your JavaScript here\\nlet count = 0;\"}', 'javascript', 'hard', 300, 250, 'dom-manipulation', 1, 1, 1, '[{\"type\":\"html\",\"description\":\"Should have counter display element\",\"selector\":\"#count\",\"expected\":{\"exists\":true}},{\"type\":\"html\",\"description\":\"Should have all three buttons\",\"selector\":\"button\",\"expected\":{\"count\":4}}]', 'Use getElementById and addEventListener. Update the count span innerHTML.', 'Track count in a variable, add event listeners to buttons, update DOM', '2025-11-05 00:52:17');
...
--
-- Table structure for table `pvp_quiz_questions`
--

CREATE TABLE `pvp_quiz_questions` (
  `id` int(11) NOT NULL,
  ...
  `time_limit` int(11) DEFAULT 45,
  `explanation` text DEFAULT NULL,
  `created_at` datetime DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `pvp_quiz_questions`
--

INSERT INTO `pvp_quiz_questions` (`id`, `question`, `difficulty`, `choices`, `correct_index`, `time_limit`, `explanation`, `created_at`) VALUES
(1, 'Which of the following correctly defines a function in JavaScript?', 'normal', '[\"function = myFunc() {}\", \"define myFunc() {}\", \"function myFunc() {}\", \"func myFunc() {}\"]', 2, 45, 'In JavaScript, the correct syntax to define a function is function myFunc() {}. This declares a function named myFunc that can be called later in the code.', '2025-10-22 17:10:56'),
(2, 'TRUE or FALSE: HTML is a programming language.', 'normal', '[\"True\", \"False\"]', 1, 45, '', '2025-10-22 23:58:02'),
(3, 'Which CSS property is used to change the text color of an element?', 'normal', '[\"font-style\", \"background-color\", \"color\", \"text-align\"]', 2, 45, 'The color property in CSS sets the color of the text inside an element.', '2025-10-27 09:28:32'),
(4, 'What does CSS stand for?', 'easy', '[\"Colorful Style System\", \"Cascading Style Sheets\", \"Computer Style Sheets\", \"Creative Style Syntax\"]', 1, 15, 'CSS stands for Cascading Style Sheets, which define how HTML elements are styled and displayed.', '2025-11-04 09:22:57'),
(5, 'What is JavaScript primarily used for in web development?', 'normal', '[\"Styling web pages\", \"Adding interactivity to web pages\", \"Structuring web content\", \"Managing databases\"]', 1, 20, 'JavaScript is mainly used to add interactivity and dynamic behavior to websites.', '2025-11-04 10:14:37'),
(6, 'What does the <button> element do in HTML?', 'normal', '[\"Creates a hyperlink to another page\", \"Submits a form or triggers a JavaScript function\", \"Displays an image\", \"Adds a comment to the page\"]', 1, 20, 'The <button> element is used to create clickable buttons that can submit forms or trigger JavaScript actions.', '2025-11-05 05:00:51');
...
CREATE TABLE `users` (
  ...
  `code_rating` int(11) DEFAULT 1000,
...
INSERT INTO `users` (`id`, `username`, `email`, `password`, `role`, `created_at`, `avatar_path`, `code_rating`, `google_id`) VALUES
(7, 'admin', 'admin@gmail.com', '$2b$12$.cAnGGuGGUWed8UFJUhPlOvbx2q8f23boABXXtZ7V/ayInVZVHCFC', 'admin', '2025-05-12 00:42:42', NULL, 1000, NULL),
(8, 'lux', 'luxparradon@gmail.com', '$2b$12$r6Uel/eUjc1IJ1PnO/wm1On62n0EIHU1RyF0Ei9cVPrFlgBO3laoS', '', '2025-05-15 19:38:30', '/static\\uploads\\lesson_images\\1761524851_reyna-valorant.jpg', 1000, '115518342795594910869'),
(9, 'leblanc', 'lebevaine@gmail.comm', '$2b$12$DKzzWb63.HbiQeC4TMv2LuizZfctocbeay06zpQf6RG7shcsLYQ46', '', '2025-05-15 22:55:43', NULL, 1000, NULL),
(10, 'jeric', 'jericcanva@cesbizmain.store', '$2b$12$Dopi8q3dbQxu.hsRFVqA1eywefQKTa9KUYrDFE3WvGQwdhxCDcU8e', '', '2025-05-23 14:48:59', NULL, 1000, NULL),
(14, 'lorena', 'lorena@gmail.com', '$2b$12$dxQO3Be0hvHUC3q56hTYb.cBs7Y105m.gZ.x4FReHgtjSZI7zS2cK', '', '2025-06-18 13:41:25', NULL, 1000, NULL),
(15, 'ahri', 'ahri@gmail.com', '$2b$12$5R0uV/Tp7KAGKuqTUSyF.eqVOIheHsAClX05uMHTU7odrkbHUaSTq', '', '2025-06-20 05:43:13', NULL, 1000, NULL),
(16, 'anivia', 'anivia@gmail.com', '$2b$12$aQhE8UOVvXVpIPF3Tak15u9vWOIq9umw0CpRQpVI84uDYY.yDgkXm', '', '2025-06-21 23:24:04', NULL, 1000, NULL),
(17, 'apple', 'apple@gmail.com', '$2b$12$q9BHeJ6YaBFtFqJO/BCXtunKza0MSw3fH9swyif9NJFfofC9pTbMO', '', '2025-07-01 22:49:54', NULL, 1000, NULL),
(19, 'lime', 'lime@gmail.com', '$2b$12$AMN0ndNOXfczWJwQiysvVeCslHXnJIygglojTfTg7zLMJygj6kgkK', '', '2025-07-17 12:10:01', NULL, 1000, NULL),
(20, 'leblancevainee', 'lebevaine@gmail.com', '', 'student', '2025-09-24 01:50:55', '/static\\uploads\\lesson_images\\1758653510_6ec175e1-5a0f-4eec-afcd-746f43d35f5a-removebg-preview.png', 1000, '105726867713002025007'),
(21, 'peñaverdeannelorraine', 'annelorrainepenaverde@gmail.com', '', 'student', '2025-09-24 13:34:28', '/static\\uploads\\lesson_images\\1758692089_Screenshot_2025-09-23_210750.png', 1000, '111382505205402802995'),
(22, 'naldo', 'naldo@gmail.com', '$2b$12$GFm/Np/Eyx.NqQUBjpspFOIRUDKpPxYRaNquEjN/.xWM4JGyS1H7i', 'student', '2025-10-20 19:40:51', NULL, 1000, NULL),
(32, 'paula', 'paula@gmail.com', '$2b$12$gEXqLaaPka2BPslTyu813.91wRgz/lmOZngTJ78nP47Q9JuplhZPa', 'student', '2025-10-20 21:29:57', NULL, 1000, NULL),
(33, 'portin', 'portin@gmail.com', '$2b$12$2cA8dUSEuAPji/hI3pljveiHd9kXuQMN6FQiOd5wbS0Oi2DyjzD/a', 'student', '2025-10-22 14:26:12', NULL, 1000, NULL),
(34, 'KC', 'sasa@gmail.com', '$2b$12$UsDTw7NWgnlNzs7ycT1p6uKPxKKfor6ijxPRYG8yA16pWj21/WQfe', 'student', '2025-10-29 02:38:16', NULL, 1000, NULL),
(35, 'kyle', 'kyle@gmail.com', '$2b$12$TspDxVe8f2jQG/1Nw9NrreynpWiZJ0NKMcvhzRxC1IMRCxPK5TRe2', 'student', '2025-10-29 22:35:06', '/static\\uploads\\lesson_images\\1761748523_download.jpg', 1000, NULL);
...
(7, 1, '2025-10-21 22:57:49'),
(8, 1, '2025-06-18 04:59:19'),
(8, 2, '2025-06-18 04:59:38'),
(8, 4, '2025-06-03 03:17:20'),
(9, 1, '2025-10-23 00:27:43'),
(34, 1, '2025-10-29 02:43:21'),
(35, 1, '2025-10-29 22:36:08');
...
(1346, 8, 47, 100, 1, '2025-09-29 19:35:38'),
...
(1411, 22, 44, 100, 1, '2025-10-20 11:42:02'),
(1419, 22, 45, 100, 1, '2025-10-20 11:43:42'),
(1524, 32, 44, 0, 0, '2025-10-20 13:30:00'),
(1528, 7, 44, 100, 1, '2025-10-21 14:57:32'),
(1536, 7, 47, 100, 1, '2025-10-21 15:11:49'),
(1548, 9, 44, 100, 1, '2025-10-22 16:27:33'),
(1555, 7, 39, 0, 0, '2025-10-22 17:40:45'),
(1586, 34, 44, 100, 1, '2025-10-28 18:38:30'),
(1593, 34, 45, 75, 0, '2025-10-28 18:43:44'),
(1607, 35, 44, 100, 1, '2025-10-29 14:35:36'),
(1628, 9, 46, 14, 0, '2025-11-01 23:19:57'),
(1642, 9, 45, 0, 0, '2025-11-02 00:43:01'),
(1668, 7, 45, 0, 0, '2025-11-04 21:45:40'),
(1678, 8, 48, 20, 0, '2025-12-19 01:09:53');
...
(7, 200, 1, 100, 150, '2025-10-22 05:15:16'),
(8, 1850, 1, 875, 414, '2025-12-19 10:02:43'),
(9, 100, 1, 50, 125, '2025-10-23 00:27:43'),
(15, 200, 1, 100, 150, '2025-10-22 05:15:16'),
(19, 200, 1, 100, 120, '2025-10-22 05:15:16'),
(22, 250, 1, 125, 154, '2025-10-22 05:15:16'),
(34, 100, 1, 50, 125, '2025-10-29 02:43:21'),
(35, 100, 1, 50, 125, '2025-10-29 22:36:08');
...
ALTER TABLE `chapters`
  ...
  ADD KEY `idx_chapters_level_order` (`level_id`,`order_num`);

--
-- Indexes for table `daily_ai_usage`
--
...
ALTER TABLE `lesson_choices`
  ...
  ADD KEY `idx_lesson_choices_content` (`lesson_content_id`);
...
ALTER TABLE `lesson_comments`
  ...
  ADD KEY `lesson_content_id` (`lesson_content_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_lesson_comments_created` (`lesson_content_id`,`created_at`);

--
-- Indexes for table `lesson_comment_likes`
--
ALTER TABLE `lesson_comment_likes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniq_comment_like` (`comment_id`,`user_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_lesson_comment_likes_comment` (`comment_id`),
  ADD KEY `idx_lesson_comment_likes_count` (`comment_id`);

--
-- Indexes for table `lesson_comment_replies`
--
ALTER TABLE `lesson_comment_replies`
  ADD PRIMARY KEY (`id`),
  ADD KEY `comment_id` (`comment_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_lesson_replies_created` (`comment_id`,`created_at`);
...
ALTER TABLE `lesson_content`
  ...
  ADD KEY `idx_lesson_content_chapter_page` (`chapter_id`,`page_num`);
...
--
-- Indexes for table `lesson_reply_likes`
--
ALTER TABLE `lesson_reply_likes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_reply_user_like` (`reply_id`,`user_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `idx_lesson_reply_likes_count` (`reply_id`);
...
--
-- Indexes for table `pvp_code_battle_history`
--
ALTER TABLE `pvp_code_battle_history`
  ADD PRIMARY KEY (`id`),
...
--
-- Indexes for table `pvp_code_challenges`
--
ALTER TABLE `pvp_code_challenges`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pvp_code_created_at` (`created_at`),
...
--
-- Indexes for table `pvp_quiz_questions`
--
ALTER TABLE `pvp_quiz_questions`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pvp_quiz_created_at` (`created_at`);
...
ALTER TABLE `users`
  ...
  ADD KEY `idx_code_rating` (`code_rating`);
...
--
-- AUTO_INCREMENT for table `lesson_comment_likes`
--
ALTER TABLE `lesson_comment_likes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `lesson_comment_replies`
--
ALTER TABLE `lesson_comment_replies`
...
--
-- AUTO_INCREMENT for table `lesson_reply_likes`
--
ALTER TABLE `lesson_reply_likes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `pvp_code_battle_history`
--
ALTER TABLE `pvp_code_battle_history`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pvp_code_challenges`
--
ALTER TABLE `pvp_code_challenges`
...
--
-- AUTO_INCREMENT for table `pvp_quiz_questions`
--
ALTER TABLE `pvp_quiz_questions`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Constraints for table `daily_ai_usage`
--
ALTER TABLE `daily_ai_usage`
  ADD CONSTRAINT `daily_ai_usage_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `lesson_comments`
  ADD CONSTRAINT `lesson_comments_ibfk_1` FOREIGN KEY (`lesson_content_id`) REFERENCES `lesson_content` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_comments_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `lesson_comment_likes`
--
ALTER TABLE `lesson_comment_likes`
  ADD CONSTRAINT `lesson_comment_likes_ibfk_1` FOREIGN KEY (`comment_id`) REFERENCES `lesson_comments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_comment_likes_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `lesson_comment_replies`
--
ALTER TABLE `lesson_comment_replies`
  ADD CONSTRAINT `lesson_comment_replies_ibfk_1` FOREIGN KEY (`comment_id`) REFERENCES `lesson_comments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_comment_replies_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `lesson_reply_likes`
--
ALTER TABLE `lesson_reply_likes`
  ADD CONSTRAINT `lesson_reply_likes_ibfk_1` FOREIGN KEY (`reply_id`) REFERENCES `lesson_comment_replies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `lesson_reply_likes_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `pvp_code_battle_history`
--
ALTER TABLE `pvp_code_battle_history`
  ADD CONSTRAINT `pvp_code_battle_history_ibfk_1` FOREIGN KEY (`player1_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pvp_code_battle_history_ibfk_2` FOREIGN KEY (`player2_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `pvp_code_battle_history_ibfk_3` FOREIGN KEY (`winner_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
