...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 14, 2025 at 11:00 PM
...
(19, 5, 'Program robots', 0),
(20, 5, 'Hack NASA', 0),
(21, 5, 'Structure and build web pages', 1);
...
INSERT INTO `lesson_content` (`id`, `chapter_id`, `page_num`, `title`, `content`, `image_url`, `code_example`, `next_button_text`, `page_type`) VALUES
(2, 5, 1, 'Introduction', 'This is sample text content', 'https://lecontent.sololearn.com/material-images/556eb06d9ba4465ba4f7c127e352ce9e-4b1d81f4aa5e46038fbe64c37f953912-01.png', '', 'Next', 'text_image'),
(3, 5, 2, 'Code Sample', 'This is sample HTML code:', 'https://lecontent.sololearn.com/material-images/556eb06d9ba4465ba4f7c127e352ce9e-4b1d81f4aa5e46038fbe64c37f953912-01.png', '<h1>Hi, welcome to WebScape!</h1>', 'Next', 'text_code'),
(5, 5, 3, '', 'HTML code is used to:', '', '', 'Check', 'quiz');
...
(1, 8, 5, NULL, 0, '2025-05-18 20:17:12'),
(2, 9, 5, NULL, 0, '2025-05-20 05:12:13'),
(3, 10, 5, NULL, 0, '2025-05-23 07:05:42');
